...
## Instalación de herramientas en Kali

### Instalación de Netcat

**Netcat** es una herramienta fundamental en entornos de ciberseguridad, utilizada para la conexión a servicios, transferencia de datos y pruebas de explotación.
